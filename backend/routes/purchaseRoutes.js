...
router.get('/orders', verifyToken, verifyRole(['Admin', 'Manager', 'Asistente', 'Subcheff']), getPendingOrders);
router.get('/orders/:orderId', verifyToken, verifyRole(['Admin', 'Manager', 'Asistente', 'Subcheff']), getOrderDetails);
